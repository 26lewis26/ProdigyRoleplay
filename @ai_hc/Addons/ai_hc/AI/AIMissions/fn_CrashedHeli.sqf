...
_crate = [heliCrash] call AI_HC_fnc_spawn_weapons_crate;
_groupToDestroy = [_spawnPos,6,2,2,2] call AI_HC_fnc_spawn_soldiers;
_markerToDestroy = [heliCrash,"heliCrashMarker","ColorRed","Helicopter Crash Site","mil_warning"] call AI_HC_fnc_spawn_mission_marker;

_destroyArray pushback heliCrash;
_destroyArray pushback _crate;

_endMission = [_missionTimeout,_destroyArray,_groupToDestroy,_markerToDestroy,1,_timer] spawn AI_HC_fnc_end_mission;
