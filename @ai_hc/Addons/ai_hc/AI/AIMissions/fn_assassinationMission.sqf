...
_unitToDestroy = [_spawnPos,informerHouse] call AI_HC_fnc_spawn_unit;

_markerToDestroy = [informerHouse,"heliCrashMarker","ColorRed","Informant Location","mil_warning"] call AI_HC_fnc_spawn_mission_marker;

_destroyArray pushback informerHouse;

_endMission = [_missionTimeout,_destroyArray,_groupToDestroy,_markerToDestroy,4,_timer] spawn AI_HC_fnc_end_mission;
