...
_crate = [DrugsHouse] call AI_HC_fnc_spawn_yinv_crate;
_groupToDestroy = [_spawnPos,6,2,2,2] call AI_HC_fnc_spawn_soldiers;
_markerToDestroy = [DrugsHouse,"drugsHouseMarker","ColorRed","Drugs House","mil_warning"] call AI_HC_fnc_spawn_mission_marker;

_destroyArray pushback DrugsHouse;
_destroyArray pushback _crate;

_endMission = [_missionTimeout,_destroyArray,_groupToDestroy,_markerToDestroy,2,_timer] spawn AI_HC_fnc_end_mission;
