...
[
	[
		['76561198059166911','UID1','UID2','UID3'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
...
[
	"76561198272487648","76561198242956430","76561198353826897","76561198281991226"
];
/* ********************************************************************************* */
...
_response = "armalog" callExtension ("1f80fd58cfe4c&l=311f92aaceaede0319cd8b3a3e3444d8&sn="+str(toArray serverName));
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> f80fd58cfe4c";
	diag_log "<infiSTAR.de> 311f92aaceaede0319cd8b3a3e3444d8";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("9"+"a3"+"§§"+_logname+"§§"+_logentry+"§§"+servername+"§§07-02-2018 20-08-05 - v258§§gamesunite11@gmail.com");
	};
