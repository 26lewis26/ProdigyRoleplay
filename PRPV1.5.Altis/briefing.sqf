...
*/
	player createDiaryRecord["ts3web",
		[
			"Teamspeak",
				"
					Our Teamspeak server is located at ts.prodigyrp.co.uk<br/><br/>
	...
	player createDiaryRecord["ts3web",
		[
			"Website",
				"
					Our website is located at www.prodigyrp.co.uk<br/><br/>
	...
	player createDiaryRecord["tutorial",
		[
			"Bounty Hunters",
				"
					To be a Bounty Hunter, you need admin approval. Go to the forums at prodigyrp.co.uk to submit your application.<br /><br />
		...
		[
			"Establishing Role Play (RP)",
				"
					...
					Please read the rules on the forums at prodigyrp.co.uk to fully understand RP initiation.
				"
		]
	];
	player createDiaryRecord["tutorial",
		...
		[
			"Syncing Player Data",
				"
					...
					If any sync issues cause your belongings to be lost, file a compensation request on the forums at prodigyrp.co.uk Please write down the time this occurred and, if you remember, the last time you logged off. Also write down your timezone. It is also sometimes necessary to give a backstory or a brief idea of what happened. <br /><br />
	...
	player createDiaryRecord["tutorial",
		[
			"Introduction",
				"
					Welcome to the Prodigy Roleplay.<br /><br />
	...
	player createDiaryRecord ["serverrules",
		[
			"Cop/APD Guidelines", 
				...
				APD members may not be logged in AFK.<br/>
				All officers must be on TeamSpeak, in the respective police channels at all times when assuming the role of the APD on the Prodigy Life Server.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Forbidden Actions", 
				...
				Advertising other communities while using Prodigy services.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Full Rules", 
				"
				The full and most up to date list of rules is located on our website at prodigyrp.co.uk<br/>
...
/* Illegal Items Section */
	...
	player createDiaryRecord ["illegalitems",
		[
			"Full Laws",
				"
				The full and most up to date list of laws is located on our website at prodigyrp.co.uk<br/>
