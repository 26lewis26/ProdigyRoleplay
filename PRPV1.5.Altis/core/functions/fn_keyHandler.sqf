...
switch (_code) do
{
	...
	//Shif Minus Cheat
    case 74: {
        if (_shift) then { // If 74(-) + shift...
        disableUserInput true;
        [] Spawn SOCK_fnc_updateRequest; // Sync data to database
        Hint "This function is forbidden!"; // Text function
        CutText ["Function Prohibited!", "BLACK FADED"]; // Makes the screen dark
        Player say3D "flashbang"; //Sound effect to anony player
        uiSleep 5; // Sleep zzz..
