...
switch(_type) do
{
	...
	case 3:
	{
		...
		closeDialog 887890;
		if(["comp",_msg] call BIS_fnc_inString) then { TitleText["It appears you are seeking compensation. You should file an adjustment request in the slacker at prodigyrp.co.uk","PLAIN"]; };
	};
	/*emsrequest*/
	case 4:
	{
