...
switch (_filter) do
{
    ...
    case 0:
    {
        switch (__GETC__(life_coplevel)) do {
            case 0: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
            case 1: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
            case 2: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
            case 3: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
            case 4: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
            case 5: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
            case 6: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
            case 7: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
            case 8: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
			case 9: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
			case 10: { _ret pushBack ["U_B_CombatUniform_mcam","Uniform",10]; };
        };
        switch (__GETC__(life_coplevel)) do {
            case 4: { _ret pushBack ["U_IG_Guerilla2_1","NOT IN USE",10]; };
            case 5: { _ret pushBack ["U_IG_Guerilla2_1","NOT IN USE",10]; };
            case 6: { _ret pushBack ["U_IG_Guerilla2_1","NOT IN USE",10]; };
            case 7: { _ret pushBack ["U_IG_Guerilla2_1","NOT IN USE",10]; };
            case 8: { _ret pushBack ["U_IG_Guerilla2_1","NOT IN USE",10]; };
			case 9: { _ret pushBack ["U_IG_Guerilla2_1","NOT IN USE",10]; };
			case 10: { _ret pushBack ["U_IG_Guerilla2_1","NOT IN USE",10]; };
        };
		
		switch (__GETC__(life_coplevel)) do {
            case 0: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
            case 1: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
            case 2: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
            case 3: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
			case 4: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
            case 5: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
            case 6: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
            case 7: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
            case 8: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
			case 9: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
			case 10: { _ret pushBack ["U_I_CombatUniform","SCO-Uniform",10]; };
        };
