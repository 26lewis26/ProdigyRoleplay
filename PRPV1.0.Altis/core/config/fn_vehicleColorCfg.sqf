...
switch (_vehicle) do
{
    ...
    case "B_Heli_Transport_01_F":
    {
        _ret =
        [
            ["images\Ghost.paa","cop","images\Ghost1.paa"]
        ];
    };
    ...
    case "B_Heli_Transport_03_unarmed_F":
    {
        _ret =
        [
            ["a3\air_f_heli\heli_transport_03\data\heli_transport_03_ext01_co.paa","cop","a3\air_f_heli\heli_transport_03\data\heli_transport_03_ext02_co.paa"]
    ...
    case "C_Hatchback_01_sport_F":
    {
        ...
        [
            ...
            ["images\cop_hatchback.paa","cop"],
            ["images\med_hatchback.paa","Medic"]
        ];
    };
    ...
    case "C_Offroad_01_F":
    {
        ...
        [
            ...
            ["#(ai,64,64,1)Fresnel(0.3,3)","fed"],
            ["images\cop_offroader.paa","cop"],
            ["#(ai,64,64,1)Fresnel(0.3,3)","fed"],
            ["images\medicoff.jpg","Medic"],
            ["images\offr6.paa","civ"],
            ["images\DIGIBLUE.jpg","civ"],
            ["images\DIGIGREY.jpg","civ"],
            ["images\DIGIPINK.jpg","civ"],
            ["images\DIGIRED.jpg","civ"]
        ];
    };
    ...
    case "C_Hatchback_01_F":
    {
        ...
        [
            ...
            ["\a3\soft_f_gamma\Hatchback_01\data\hatchback_01_ext_base05_co.paa","fed"],
            ["images\cop_hatchback.paa","cop"],
            ["images\med_hatchback.paa","Medic"]
        ];
    };
    ...
    case "B_MRAP_01_F":
    {
        _ret = 
        [
        ["images\cop_hunter_front.paa","cop","images\cop_hunter_back.paa"]
        ];
    };
