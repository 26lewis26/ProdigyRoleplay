...
[] spawn {
	_action = ["Do you wish to provide valuable feedback on your experience with the APD today? We are looking for constructive criticism from our players to help improve the police force. You will be compensated for doing so.", "APD Survey", "Yes", "No"] call BIS_fnc_guiMessage;
	if(!_action) exitWith {};
