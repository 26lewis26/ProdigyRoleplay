...
switch (_side) do
{
	...
	{
		_return = [
			["cop_spawn_4","Kavala HQ","\a3\ui_f\data\map\Markers\NATO\b_air.paa"],		
			["cop_spawn_3","Athira HQ","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"],
			["cop_spawn_2","Pyrgos HQ","\a3\ui_f\data\map\MapControl\fuelstation_ca.paa"],
			["cop_spawn_1","Air HQ","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
	...
	{
		_return = [
			["civ_spawn_6","Kavala","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],		
